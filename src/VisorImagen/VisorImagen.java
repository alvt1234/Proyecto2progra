...
public class VisorImagen extends JFrame {
    ...
    public VisorImagen() {
        ...
        getContentPane().setBackground(new Color(30, 30, 30)); // gris oscuro

        JLabel titleLabel = new JLabel("Visor de Imágenes", SwingConstants.CENTER);
        titleLabel.setFont(new Font("Arial", Font.BOLD, 18));
        titleLabel.setForeground(new Color(255, 255, 255)); // blanco
        ...
        imagePanel.setBackground(new Color(30, 30, 30)); // gris oscuro
